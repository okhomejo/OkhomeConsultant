package id.co.okhome.consultant.lib.jobrowser.util;
...
//    }
    ...
    public static void setMobileAppUserAgent(Context context){
        mobileAppUserAgent = JoBrowserUtil.getUserAgent(context);
    }
    ...
    public static final String makeParamForInstagram(Map<String, String> mapParam){
        ...
        param = "ig_sig_key_version=4&signed_body=" + JoBrowserUtil.encodeUTF8(param);
        return param;
    }
...
//        String shortenedId = JoBrowserUtil.getMediaCodeFromMediaId(mediaId);
//
...
//        }
        ...
        Uri uri = Uri.parse("http://instagram.com/p/" + JoBrowserUtil.getMediaCodeFromMediaId(mediaId));
