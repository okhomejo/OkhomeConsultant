...
import id.co.okhome.consultant.view.viewholder.FaqVHolderV2;

/**
 * Created by frizurd on 16/03/2018.
 */

public class TraineeFaqActivityV2 extends OkHomeParentActivity {
    ...
    private void initRecyclerView(){
        ...
        adapter = new JoRecyclerAdapter(new JoRecyclerAdapter.Params()
                .setRecyclerView(rcv)
                .setItemViewHolderCls(FaqVHolderV2.class)
